...
run_force_actions() {
  ...
  if [[ "${needs_repo}" == "true" && "${SCOPE}" != "foundation" ]]; then
    bootstrap_env_info "Reconciling Control Plane UI companion"
