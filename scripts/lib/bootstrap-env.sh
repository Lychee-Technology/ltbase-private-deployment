...
bootstrap_env_apply_derivations() {
  ...
  export LTBASE_LTSEARCH_MODE LTBASE_CDC_MODE LTBASE_LTFLOW_MODE
  export LTBASE_SEMANTIC_MODE LTBASE_GOVERNANCE_MODE LTBASE_GOVERNANCE_ACTION_MODE
  export FORMA_CDC_S3_PREFIX
